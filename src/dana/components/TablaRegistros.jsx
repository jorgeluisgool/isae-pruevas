...
const TableRegistros = ({data, headers, onDelete, onEdit, selectedRows, isSelected, onSelectedRow, setModalAbrirCerrar}) => {
  return (
          ...
          <tr key={index} onClick={() => { setModalAbrirCerrar(true)}} className='cursor-pointer hover:bg-[#E2E2E2]'>
            <td className="px-6">
              <div className="flex items-center">
                ...
                <div className="ml-8">
                  <div className="text-sm font-medium text-gray-900 cursor-pointer">{item.name}</div>
